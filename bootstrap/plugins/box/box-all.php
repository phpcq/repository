...
return new class implements ConfigurationPluginInterface {
        ...
        $configOptionsBuilder
            ...
            */
            ...
            ->describeStringOption(
                'datetime',
                <<<EOF
                The datetime (string|null default null) setting is the name of a placeholder value that will be replaced
                in all non-binary files by the current datetime. If no value is given (null) then this placeholder will
                be ignored.
    ...
    private function buildConfig(array $config): array
    {
        ...
        if (null !== $value = $config['main'] ?? null) {
        ...
        if (null !== $value = $config['key_pass'] ?? null) {
        ...
        if (null !== $value = $config['shebang'] ?? null) {
            // Fixup empty string to false, as we do not allow type invariance in configuration.
            $contents['shebang'] = ('' === $value) ? false : $value;
        }

        if (null !== $value = $config['stub'] ?? null) {
            switch ($value) {
                case 'default':
                    $value = true;
                    break;
